...
function reverseFizzBuzz(array) {
  ...
  array.forEach((val, idx) => {
    let i = idx + 1;
    if (val === "Fizz") fizzIndexes.push(i);
    else if (val === "Buzz") buzzIndexes.push(i);
  ...
  let fizz = findDivisor(fizzIndexes);
  let buzz = findDivisor(buzzIndexes);
